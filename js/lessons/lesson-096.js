...
"args": [
    ...
    "-s"  # Mostrar prints en la terminal
        ...
        <pre><code class="python"># tests/test_login_debug.py
import pytest
...
class TestLoginDebug:
    ...
    def test_login_exitoso(self, page: Page):
        ...
        <pre><code class="python"># tests/test_tabla_debug.py
import pytest
from playwright.sync_api import Page, expect
...
class TestTablaDebug:
    ...
    def test_procesar_filas_tabla(self, page: Page):
        ...
        <pre><code class="python"># En lugar de agregar prints temporales en el código:
...
class TestNavegacion:
    def test_flujo_completo(self, page: Page):
        ...
        <pre><code class="python"># Atajos del debugger de VS Code:
#
...
class TestCheckoutDebug:
    ...
    def _agregar_al_carrito(self, page: Page):
        ...
        <pre><code class="python"># Mientras estás pausado en un breakpoint, escribe en la Debug Console:
...
# → '/dashboard'</code></pre>
        ...
        <pre><code class="python"># conftest.py - con puntos de debug estratégicos
import pytest
...
class TestEmpleado:
    def test_crear_empleado(
        ...
        <pre><code class="python"># Paso 1: Instalar debugpy en el entorno remoto
# pip install debugpy
  ...
  playwright-tests:
    ...
    volumes:
      ...
      - ./pages:/app/pages</code></pre>
        ...
        <pre><code class="python"># tests/test_con_pdb.py
import pytest
from playwright.sync_api import Page, expect
        ...
        <pre><code class="json">// Agregar DEBUG a la configuración de VS Code
{
    ...
    "env": {
        ...
        <pre><code class="python"># Problema: TimeoutError: Timeout 30000ms exceeded waiting for selector
...
class TestElementoNoEncontrado:
    def test_debug_selector(self, page: Page):
        ...
        <pre><code class="python"># Problema: Navigation timeout exceeded
...
class TestTimeoutNavegacion:
    def test_debug_navegacion_lenta(self, page: Page):
        ...
        <pre><code class="python"># Problema: Test que a veces pasa y a veces falla
