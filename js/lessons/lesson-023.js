...
const LESSON_023 = {
    ...
    content: `
        ...
        <pre><code class="python"># Lectura básica de un archivo de texto
...
with open("log_tests.txt", "a", encoding="utf-8") as archivo:
    archivo.write("2026-04-03 10:30 - test_login: PASSED\\n")</code></pre>
        ...
        <div style="background: #fff3e0; padding: 15px; border-radius: 8px; margin: 15px 0;">
            ...
            <pre><code class="python"># ❌ EVITAR - El archivo podría no cerrarse si hay un error
...
print(usuarios["usuario_regular"]["rol"])     # "usuario"</code></pre>
        ...
        <pre><code class="python"># --- Escribir resultados en JSON ---
resultados = {
    "suite": "smoke_tests",
    "total": 15,
    "passed": 14,
...
with open("resultados.json", "w", encoding="utf-8") as f:
    ...
    # ensure_ascii=False: permite caracteres como ñ, á, etc.</code></pre>
        ...
        <pre><code class="python"># test_data/login_scenarios.json
# [
...
def test_login_con_datos_json(page: Page, escenario):
    ...
    if escenario["esperado"] == "dashboard":
        ...
        <pre><code class="bash">pip install pyyaml</code></pre>
...
print(config["credenciales"]["admin"]["username"]) # "admin"</code></pre>
        ...
        <pre><code class="python"># --- Uso práctico: fixture que carga config YAML ---
# conftest.py
import pytest
import yaml
...
def test_pagina_principal(page, test_config):
    ...
    # El test usa configuración del YAML</code></pre>
        ...
        <pre><code class="python"># --- Escribir YAML (generar reportes o configs) ---
import yaml
...
with open("test_data/productos.csv", "r", encoding="utf-8") as f:
    ...
    for fila in reader:
        ...
        <pre><code class="python"># --- CSV para tests parametrizados con Playwright ---
import csv
import pytest
from playwright.sync_api import Page, expect
...
def test_busqueda_productos(page: Page, datos):
    ...
    if expected == 0:
        ...
        <pre><code class="python"># --- Escribir resultados en CSV ---
import csv
