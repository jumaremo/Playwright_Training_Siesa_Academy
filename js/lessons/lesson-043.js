...
const LESSON_043 = {
    ...
    content: `
        ...
        <div class="code-tabs" data-code-id="L043-1">
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-python"># ✅ EXCELENTE: Basados en cómo el usuario ve la página
...
page.locator("div > div > form > button:nth-child(3)")</code></pre>
            ...
            <div class="code-panel" data-lang="typescript">
                <pre><code class="language-typescript">// ✅ EXCELENTE: Basados en cómo el usuario ve la página
page.getByRole('button', { name: 'Guardar cambios' });
page.getByRole('textbox', { name: 'Correo electrónico' });
page.getByRole('link', { name: 'Ir al carrito' });
page.getByRole('heading', { name: 'Bienvenido' });
page.getByRole('checkbox', { name: 'Acepto los términos' });
...
page.getByTitle('Configuración de perfil');
...
page.locator('div > div > form > button:nth-child(3)');</code></pre>
        ...
        <div class="code-tabs" data-code-id="L043-2">
            <div class="code-tabs-header">
                <button class="code-tab active" data-lang="python" onclick="window.PWAcademy.switchTab(this)">
                    <span class="code-tab-icon">🐍</span> Python
                </button>
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-python"># En el HTML (agregado por desarrollo):
...
page.get_by_test_id("product-row-42").locator("td").first</code></pre>
            ...
            <div class="code-panel" data-lang="typescript">
                <pre><code class="language-typescript">// En el HTML (agregado por desarrollo):
// <button data-testid="submit-order">
//     <svg>...icono...</svg>
// </button>
//
...
await page.getByTestId('cart-badge').textContent();
page.getByTestId('product-row-42').locator('td').first();</code></pre>
            </div>
        </div>
        ...
        <div class="code-tabs" data-code-id="L043-3">
            <div class="code-tabs-header">
                <button class="code-tab active" data-lang="python" onclick="window.PWAcademy.switchTab(this)">
                    <span class="code-tab-icon">🐍</span> Python
                </button>
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-python"># Configurar el atributo personalizado (si tu app usa otro nombre)
...
# - El texto visible es estable y significativo</code></pre>
            ...
            <div class="code-panel" data-lang="typescript">
                <pre><code class="language-typescript">// Configurar el atributo personalizado en playwright.config.ts:
...
// - El texto visible es estable y significativo</code></pre>
        ...
        <div class="code-tabs" data-code-id="L043-4">
            <div class="code-tabs-header">
                <button class="code-tab active" data-lang="python" onclick="window.PWAcademy.switchTab(this)">
                    <span class="code-tab-icon">🐍</span> Python
                </button>
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-bash"># Abrir el generador de código
...
# Con opciones adicionales
npx playwright codegen --browser chromium --viewport-size "1280,720" https://mi-sitio.com

# Generar código en TypeScript (por defecto en @playwright/test)
npx playwright codegen --target playwright-test https://mi-sitio.com

# Con dispositivo móvil
npx playwright codegen --device "iPhone 13" https://mi-sitio.com</code></pre>
            </div>
        </div>
        ...
        <div class="code-tabs" data-code-id="L043-5">
            <div class="code-tabs-header">
                <button class="code-tab active" data-lang="python" onclick="window.PWAcademy.switchTab(this)">
                    <span class="code-tab-icon">🐍</span> Python
                </button>
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-python"># Ejemplo de código generado por codegen:
...
with sync_playwright() as p:
    ...
    browser.close()</code></pre>
            ...
            <div class="code-panel" data-lang="typescript">
                <pre><code class="language-typescript">// Ejemplo de código generado por codegen:
// (Playwright elige automáticamente el mejor localizador)
...
test('login test', async ({ page }) => {
    ...
    // Codegen genera getByRole en vez de selectores CSS
    await page.getByLabel('Username').fill('tomsmith');
    await page.getByLabel('Password').fill('SuperSecretPassword!');
    await page.getByRole('button', { name: 'Login' }).click();

    // En vez de: await page.locator('#username').fill(...)
    // En vez de: await page.locator('button.radius').click()
});</code></pre>
            </div>
        </div>
        ...
        <div class="code-tabs" data-code-id="L043-6">
            <div class="code-tabs-header">
                <button class="code-tab active" data-lang="python" onclick="window.PWAcademy.switchTab(this)">
                    <span class="code-tab-icon">🐍</span> Python
                </button>
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-bash"># Abrir el Inspector durante la ejecución
...
set PWDEBUG=1 && pytest tests/test_login.py -v</code></pre>
            ...
            <div class="code-panel" data-lang="typescript">
                ...
                <pre><code class="language-bash"># Abrir el Inspector durante la ejecución
npx playwright test tests/test_login.spec.ts --debug

# O con variable de entorno:
PWDEBUG=1 npx playwright test tests/test_login.spec.ts</code></pre>
            </div>
        </div>

        <div class="code-tabs" data-code-id="L043-7">
            <div class="code-tabs-header">
                <button class="code-tab active" data-lang="python" onclick="window.PWAcademy.switchTab(this)">
                    <span class="code-tab-icon">🐍</span> Python
                </button>
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-python"># También puedes pausar programáticamente
def test_encontrar_localizador(page):
    ...
    # >> page.get_by_role("button", name="Login").is_visible()</code></pre>
            ...
            <div class="code-panel" data-lang="typescript">
                <pre><code class="language-typescript">// También puedes pausar programáticamente
test('encontrar localizador', async ({ page }) => {
    ...
    // >> page.getByRole('button', { name: 'Login' }).isVisible()
        ...
        <div class="code-tabs" data-code-id="L043-8">
            <div class="code-tabs-header">
                <button class="code-tab active" data-lang="python" onclick="window.PWAcademy.switchTab(this)">
                    <span class="code-tab-icon">🐍</span> Python
                </button>
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-python"># ✅ Se lee como instrucción humana:
...
page.locator("div:nth-child(2) > input:nth-child(3)").fill("test@example.com")</code></pre>
            ...
            <div class="code-panel" data-lang="typescript">
                <pre><code class="language-typescript">// ✅ Se lee como instrucción humana:
// "Haz clic en el botón Enviar"
...
// ❌ No se traduce a instrucciones humanas:
// "Haz clic en el div con clase MuiButton-root dentro del form"
await page.locator('form .MuiButton-root.css-abc123').click();

// "Escribe en el input que es el tercer hijo del segundo div"
await page.locator('div:nth-child(2) > input:nth-child(3)').fill('test@example.com');</code></pre>
            </div>
        </div>
        ...
        <div class="code-tabs" data-code-id="L043-9">
            <div class="code-tabs-header">
                <button class="code-tab active" data-lang="python" onclick="window.PWAcademy.switchTab(this)">
                    <span class="code-tab-icon">🐍</span> Python
                </button>
            ...
            <div class="code-panel active" data-lang="python">
                <pre><code class="language-python"># === EJERCICIO: Mejorar estos localizadores frágiles ===
...
#    (requiere que desarrollo agregue data-testid)</code></pre>
            ...
            <div class="code-panel" data-lang="typescript">
                <pre><code class="language-typescript">// === EJERCICIO: Mejorar estos localizadores frágiles ===
// Para cada uno, escribe la versión robusta usando Playwright
...
// 1. page.getByRole('button', { name: 'Enviar' })
// 2. page.getByPlaceholder('Buscar...') o page.getByRole('searchbox')
// 3. page.getByRole('link', { name: 'Contacto' })
// 4. page.getByRole('alert') o page.getByText('Operación exitosa')
// 5. page.getByRole('row', { name: 'García' })
//    o page.locator('tr').filter({ hasText: 'García' })
// 6. page.getByRole('checkbox', { name: 'Recordarme' })
//    o page.getByLabel('Recordarme')
// 7. page.getByLabel('País') o page.getByRole('combobox', { name: 'País' })
// 8. page.getByTestId('delete-item')
//    (requiere que desarrollo agregue data-testid)</code></pre>
            </div>
        </div>
