...
def test_xpath_basicos(page: Page):
    ...
    tbody = page.locator("//table[@id='table1']/tbody")</code></pre>
        ...
        <pre><code class="python">def test_xpath_ejes(page: Page):
    page.goto("https://the-internet.herokuapp.com/tables")
    ...
    inputs = page.locator("//form/descendant::input")</code></pre>
        ...
        <pre><code class="python">def test_xpath_predicados(page: Page):
    page.goto("https://the-internet.herokuapp.com/tables")
    ...
    no_hidden = page.locator("//input[not(@type='hidden')]")</code></pre>
        ...
        <pre><code class="python">def test_funciones_xpath(page: Page):
    page.goto("https://the-internet.herokuapp.com/tables")
    ...
    errores = page.locator(
        ...
        <pre><code class="python">def test_xpath_por_texto(page: Page):
    ...
    elemento = page.locator("//p[normalize-space()='Texto exacto sin espacios extra']")</code></pre>
        ...
        <div style="background: #fff3e0; padding: 15px; border-radius: 8px; margin: 15px 0;">
            ...
            <pre><code class="python"># HTML: &lt;div&gt;Hola &lt;span&gt;Mundo&lt;/span&gt;&lt;/div&gt;
...
page.locator("//div[contains(., 'Hola Mundo')]")</code></pre>
        ...
        <pre><code class="python">def test_navegacion_dom_xpath(page: Page):
    page.goto("https://the-internet.herokuapp.com/tables")
    ...
    filas_con_delete = page.locator(
        ...
        <pre><code class="python">def test_patrones_xpath_complejos(page: Page):
    ...
    input_email = page.locator(
        ...
        <div style="background: #e8f5e9; padding: 15px; border-radius: 8px; margin: 15px 0;">
            ...
            <pre><code class="python">def test_xpath_en_playwright(page: Page):
    ...
    frame.locator("//input[@name='campo']").fill("valor")</code></pre>
        ...
        <div style="background: #ffebee; padding: 15px; border-radius: 8px; margin: 15px 0;">
            ...
            <pre><code class="python"># NUNCA hagas esto — se rompe con cualquier cambio en la estructura
...
page.locator("//table[@id='datos']//tr[3]/td[2]")</code></pre>
            ...
            <pre><code class="python"># MAL — depende del orden exacto de los divs
...
page.locator("//div[@class='resultado']/span[1]")</code></pre>
            ...
            <pre><code class="python"># MAL — XPath innecesario para algo que Playwright resuelve mejor
...
page.get_by_role("button", name="Enviar")</code></pre>
            ...
            <pre><code class="python"># MAL — imposible de mantener
page.locator(
...
page.locator("//form[@id='registro']//input[@name='email']")</code></pre>
        ...
        <ol>
            ...
            <pre><code class="python"># Pista: //td[text()='jdoe@hotmail.com']/parent::tr
def test_desafio_1_padre(page: Page):
    ...
    assert celdas.count() == 6</code></pre>
            ...
            <pre><code class="python"># Pista: //td[text()='jdoe@hotmail.com']/preceding-sibling::td[...]
def test_desafio_2_hermano(page: Page):
    ...
    assert apellido.text_content() == "Doe"</code></pre>
            ...
            <pre><code class="python"># Pista: //td[text()='$50.00']/ancestor::table
def test_desafio_3_ancestro(page: Page):
    ...
    assert tabla.get_attribute("id") in ["table1", "table2"]</code></pre>
            ...
            <pre><code class="python">def test_desafio_4_normalize(page: Page):
    ...
    expect(page).to_have_url("**/tables")</code></pre>
            ...
            <pre><code class="python">def test_desafio_5_complejo(page: Page):
    page.goto("https://the-internet.herokuapp.com/tables")
