...
const LESSON_061 = {
    ...
    content: `
        ...
        <pre><code class="python"># Playwright considera un elemento INVISIBLE si:
...
visible = page.locator("#mi-elemento").is_visible()  # True/False ahora</code></pre>
        ...
        <div style="background: #e8f5e9; padding: 15px; border-radius: 8px; margin: 15px 0;">
            ...
            <pre><code class="python"># Escenario: botón que aparece con animación slide-in
...
page.click(".modal .confirm-btn")  # Espera → click</code></pre>
        ...
        <pre><code class="python"># Escenario: botón de submit se habilita cuando el formulario es válido
...
is_disabled = page.locator("#submit-btn").is_disabled()</code></pre>
        ...
        <div style="background: #fff3e0; padding: 15px; border-radius: 8px; margin: 15px 0;">
            ...
            <pre><code class="python"># Escenario: un cookie banner cubre el botón de login
...
page.click("#login-btn")</code></pre>
        ...
        <div style="background: #ffebee; padding: 15px; border-radius: 8px; margin: 15px 0;">
            ...
            <pre><code class="python"># ❌ NO auto-esperan — snapshot instantáneo
...
expect(locator).to_contain_text("parcial")</code></pre>
        ...
        <pre><code class="python"># force=True salta TODAS las verificaciones de actionability
