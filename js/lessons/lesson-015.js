...
def test_screenshot_basico(page: Page):
    ...
    page.screenshot(path="screenshots/viewport.png", full_page=False)</code></pre>
        ...
        <pre><code class="python">def test_screenshot_elemento(page: Page):
    page.goto("https://example.com")
    ...
    page.screenshot(
        ...
        <pre><code class="python">def test_screenshot_opciones(page: Page):
    page.goto("https://example.com")
    ...
    print(f"Tamaño: {len(imagen_bytes)} bytes")</code></pre>
        ...
        <pre><code class="python"># conftest.py - Configurar grabación de video
import pytest
...
def browser_context_args(browser_context_args):
    return {
        **browser_context_args,
        ...
        <pre><code class="python"># test_con_video.py
def test_flujo_login(page):
    ...
    # El video se guarda al cerrar el contexto</code></pre>
        ...
        <pre><code class="python"># conftest.py - Guardar video solo si el test falla
import pytest
import os
...
def pytest_runtest_makereport(item, call):
    ...
    setattr(item, f"rep_{rep.when}", rep)</code></pre>
        ...
        <pre><code class="bash"># pytest-playwright ya captura screenshots automáticos al fallar
# Solo ejecuta con:
